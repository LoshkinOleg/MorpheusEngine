...
| [Configuration_Reference.md](Configuration_Reference.md) | `engine_config.json`, port keys, bundled Ollama under `third_party/ollama/`, dev launch, shared contracts. |
